...
<main class="admin-main">
    <div class="container">
        ...
        <div class="admin-welcome">
            <div>
                <p class="eyebrow">Editar recurso</p>
                <h1>Actualizar <span>recurso.</span></h1>
            </div>
        ...
        <div class="form-card">
            <form method="POST" action="<?= APP_URL ?>/admin/recursos/<?= $recurso['id'] ?>/editar" enctype="multipart/form-data" novalidate>
                ...
                <div class="form-group <?= isset($errors['descripcion']) ? 'has-error' : '' ?>">
                    ...
                    <textarea id="descripcion" name="descripcion" class="form-input" rows="3"><?= htmlspecialchars($old['descripcion'] ?? '') ?></textarea>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-coral">
                        <i class="bi bi-check-lg"></i> Actualizar recurso
                    </button>
                </div>
